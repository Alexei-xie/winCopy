...
& $compiler /nologo /target:winexe /platform:anycpu /optimize+ "/resource:$PSScriptRoot\assets\logo.png,WinCopy.Logo" "/win32icon:$PSScriptRoot\assets\winCopy.ico" "/resource:$PSScriptRoot\assets\winCopy.ico,WinCopy.AppIcon" /codepage:65001 "/out:$output\winCopy.exe" "/win32manifest:$PSScriptRoot\app.manifest" /reference:System.Web.Extensions.dll /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Security.dll /reference:System.Xml.dll /reference:System.Xml.Linq.dll $sources
