...
namespace WinCopy {
    public class SnippetEditor : Form {
        ...
        public SnippetEditor(Clip clip) {
            ...
            grid.Controls.Add(new Label { Text = "分组", AutoSize = true }); group.Dock = DockStyle.Fill; group.MaxLength = 80; group.Text = clip == null ? "常用" : clip.Group; grid.Controls.Add(Design.Input(group));
