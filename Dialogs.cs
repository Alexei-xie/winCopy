...
namespace WinCopy {
    ...
    public partial class SettingsDialog : Form {
        ...
        GroupPicker key = new GroupPicker { ReadOnly = true, OptionsCaption = "选择快捷键", AccessibleName = "呼出快捷键" };
        ...
        void AddRow(FlowLayoutPanel flow, string caption, Control input) {
            ...
            if(input is GroupPicker){input.SetBounds(328,2,144,36);row.Controls.Add(input);}else{frame.Controls.Add(input);row.Controls.Add(frame);}flow.Controls.Add(row);
        }
    }
}